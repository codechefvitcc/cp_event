  ...
  return (
    <main className="min-h-screen grid lg:grid-cols-2 bg-[#050505] relative overflow-hidden">
        ...
        <div className="max-w-xl w-full grid grid-cols-2 gap-4 z-10">
            ...
            >
                <div className="flex items-center gap-3 mb-3 text-primary">
                    <Terminal size={20} />
                    <span className="font-ui text-xs font-bold tracking-widest">SYSTEM_STATUS</span>
                </div>
                <div className="font-mono text-xs text-gray-400 space-y-1">
                    <p>Initializing connection...</p>
                    <p>Loading modules: <span className="text-green-400">OK</span></p>
                    <p>Verifying integrity: <span className="text-green-400">100%</span></p>
            ...
            >
                ...
                <h3 className="font-display text-4xl font-bold text-white mb-1">10K+</h3>
            ...
            >
                ...
                <h3 className="font-display text-4xl font-bold text-white mb-1">24/7</h3>
            ...
            >
                 <div className="flex items-center gap-3 mb-3 text-primary">
                    <Network size={20} />
                    <span className="font-ui text-xs font-bold tracking-widest">ALGORITHM_OPTIMIZED</span>
                </div>
                <div className="h-16 flex items-end gap-1">
                    {[40, 70, 45, 90, 60, 80, 50, 95, 30, 60].map((h, i) => (
                        <div key={i} className="bg-primary/50 w-full" style={{ height: `${h}%` }} />
                    ))}
                </div>
            </motion.div>
        </div>
      ...
      <div className="flex flex-col items-center justify-center p-4 lg:p-12 relative z-10">
        ...
        <Link 
          href="/" 
          className="absolute top-8 left-8 text-gray-400 hover:text-primary transition-colors flex items-center gap-1 font-ui text-xs"
        >
        ...
        >
             <div className="mb-10 text-center lg:text-left">
                ...
                <p className="font-ui text-sm text-gray-400">Authenticate via Google to access the mainframe.</p>
            </div>

            <div className="space-y-4">
                <button onClick={()=>{signIn("google")}} className="w-full bg-white hover:bg-gray-100 text-black font-ui font-bold py-4 px-6 rounded-none flex items-center justify-center gap-3 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]">
                    <GoogleIcon />
                ...
                <div className="relative py-4">
                    ...
                    <div className="relative flex justify-center text-xs">
                        <span className="bg-[#050505] px-2 text-gray-600 font-ui uppercase">System Access Only</span>
                    </div>
                </div>

                <div className="text-center font-ui text-xs text-gray-600">
                    By accessing the system, you agree to the <a href="#" className="text-gray-400 hover:text-primary underline">Protocol Terms</a> and <a href="#" className="text-gray-400 hover:text-primary underline">Data Policy</a>.
                </div>
            </div>
        </motion.div>
      </div>
